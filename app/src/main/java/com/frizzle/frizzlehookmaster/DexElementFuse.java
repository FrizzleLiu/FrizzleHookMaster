...
public class DexElementFuse {
    ...
    public void mainPluginFuse(Context mContext) throws Exception {
        ...
        DexClassLoader dexClassLoader = new DexClassLoader(HookApplication.pluginPath, fileDir.getAbsolutePath(),null, mContext.getClassLoader());
    ...
    private void loadResource(Context mContext) throws Exception {
        ...
        // File file = new File(Environment.getExternalStorageDirectory() + File.separator + "p.apk");
        addAssetpathMethod.invoke(assetManager, HookApplication.pluginPath);
